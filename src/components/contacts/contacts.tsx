  ...
  return (
    <section className="my-8 sm:my-12 px-6 xl:px-20 ">
      ...
      <p className="mt-2 sm:mt-5 sm:text-xl text-lg text-slate-800 dark:text-white  sm:px-2 lg:px-0">
        {dictionary.contactsText} <strong className=" dark:text-green-500">{dictionary.linkedIn}</strong>{" "}
        {dictionary.contactsText2} <strong className=" dark:text-green-500">{dictionary.telegram}</strong>{" "}
        {dictionary.contactsText3} <strong className=" dark:text-green-500">{dictionary.gitHub}</strong>,
      ...
      <div className="my-8 mx-4 flex justify-center items-center gap-12 max-[400px]:gap-10 dark">
        ...
        >
          <svg width="80" height="80" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path

  ...
  return (
    <section className="my-8 sm:my-12 px-6 xl:px-20 ">
      <article>
        ...
        <p className="mt-2 sm:mt-5 sm:text-xl text-lg text-slate-800 dark:text-white">{dictionary.worksContent2}</p>
        ...
        <p className="mt-2 sm:text-xl text-lg text-slate-800 dark:text-white">
          {dictionary.worksContent3} <strong className=" dark:text-green-500">{dictionary.workstools}</strong>.
        </p>

        <p className="mt-2 sm:text-xl text-lg text-slate-800 dark:text-white">
          {dictionary.worksContent4} (<strong className=" dark:text-green-500">{dictionary.tools}</strong>),
          {dictionary.worksContent5} <strong className=" dark:text-green-500">{dictionary.gitHub}</strong>.
        </p>
        ...
        <hr></hr>
        <p className="mt-2 sm:text-xl text-lg text-slate-800 dark:text-white">{dictionary.worksContent6}</p>
        <p className="mt-2 sm:text-xl text-lg text-slate-800 dark:text-white">{dictionary.worksListLKS}</p>
        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 items-center sm:items-start sm:gap-6 md:gap-8 sm:my-5 my-2 list-disc">
          ...
          <li className="ml-6 sm:text-xl text-lg leading-7  text-slate-800 dark:text-white sm:px-2 lg:px-0 my-2 sm:my-0">
            {dictionary.worksItem6} <strong className=" dark:text-green-500">{dictionary.javaScript}</strong>
            {dictionary.worksContent7} <strong className=" dark:text-green-500">{dictionary.typeScript}</strong>,
            {dictionary.worksItem6} <strong className=" dark:text-green-500">{dictionary.react}</strong>
            {dictionary.worksContent7} <strong className=" dark:text-green-500">{dictionary.next}</strong>,
            {dictionary.worksItem6} <strong className=" dark:text-green-500">{dictionary.rtk}</strong>
            {dictionary.worksContent7} <strong className=" dark:text-green-500">{dictionary.swr}</strong>.
          </li>
          <li className="ml-6 sm:text-xl text-lg leading-7  text-slate-800 dark:text-white sm:px-2 lg:px-0 my-2 sm:my-0">
            {dictionary.worksItem7}
            <strong className=" dark:text-green-500">{dictionary.bem}</strong>, {dictionary.worksItem9}
            <strong className=" dark:text-green-500">{dictionary.css}</strong>.
          </li>
          <li className="ml-6 sm:text-xl text-lg leading-7  text-slate-800 dark:text-white sm:px-2 lg:px-0 my-2 sm:my-0">
            <strong className=" dark:text-green-500">{dictionary.tools3}</strong> {dictionary.worksItem8}.
          </li>
        </ul>
        <h3 className="my-2 sm:text-xl text-center text-lg text-orange-600 dark:text-orange-500 uppercase font-bold">
          {dictionary.projects}
